...
player = pygame.transform.scale(pygame.image.load('player.png').convert_alpha(), (150, 50))
player_rect = player.get_rect().move(50, HEIGHT/2-50)
...
def create_enemy():
    enemy_size = (30, 30)
    enemy = pygame.transform.scale(pygame.image.load('enemy.png'), (100, 40))
